...
plot <- gene_assoc %>% filter(n > 6) %>%
  ...
  theme_minimal() +
  coord_flip() 
CairoPDF("~/Desktop/BarabasiLab/Auto_Innate_GDA/Figures/Num_Genes_per_Disease_filtered6.pdf", width = 6, height = 6)
plot
dev.off()
...
plot <- gene_assoc %>% filter(n > 2) %>%
  ...
  theme_minimal() +
  coord_flip()
CairoPDF("~/Desktop/BarabasiLab/Auto_Innate_GDA/Figures/Num_Genes_per_Disease_filtered2.pdf", width = 10, height = 25)
plot
dev.off()
...
CairoPDF("~/Desktop/BarabasiLab/Auto_Innate_GDA/Figures/Autoimmune_dis_Jacc.pdf", height = 14, width = 18)
plot
dev.off()
...
CairoPDF("~/Desktop/BarabasiLab/Auto_Innate_GDA/Figures/Autoimmune_dis_Jacc_filt.pdf", height = 16, width = 25)
plot
dev.off()
...
pdf("~/Desktop/BarabasiLab/Auto_Innate_GDA/Figures/Autoimmune_dis_Jacc_heatmap.pdf", height = 6, width = 9)
superheat(jacc_dis_mat_full, pretty.order.rows = T, pretty.order.cols=T, scale=F, 
          heat.pal = c("white", "red"), heat.pal.values = c(0, 0.07, 1), 
...
CairoPDF("/Users/ursulawidocki/Desktop/BarabasiLab/Auto_Innate_GDA/Figures/Num_Dis_Genes_per_Immune_Comp.pdf", height = 25, width = 20)
p1 
dev.off()
