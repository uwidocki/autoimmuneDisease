...
pdfinal$tissue <- as.factor(pdfinal$tissue)
pdfinal$subject <- as.factor(pdfinal$subject)
```
...
dds <- DESeqDataSetFromMatrix(countData = cnts,
                              colData = pdfinal,
                              design = ~ tissue + tissue:subject)

dds <- DESeq(dds, parallel = T) # performs internal normalization by sampl
