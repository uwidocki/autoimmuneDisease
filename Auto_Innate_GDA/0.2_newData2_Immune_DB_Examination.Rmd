...
ComplexUpset::upset(
    ...
    themes=upset_modify_themes(
        list(
            'intersections_matrix' = theme(text=element_text(size=40)),
            'overall_sizes' = theme(axis.text.x=element_text(size=40)),
            "default" = theme(text=element_text(size=40))
        )
    )
...
CairoPDF("/Users/ursulawidocki/Desktop/BarabasiLab/Auto_Innate_GDA/Figures/Database_Jacc_Imm_Components.pdf", height = 6, width = 8)
...
## Plotting
pdf(file = "/Users/ursulawidocki/Desktop/BarabasiLab/Auto_Innate_GDA/Figures/ReactomeDB_LCC_distrib.pdf", height = 6, width = 8)
...
CairoPDF("/Users/ursulawidocki/Desktop/BarabasiLab/Auto_Innate_GDA/Figures/ReactomeDB_LCC_distrib_plots.pdf", width = 8, height = 10)
...
top_deg_proteins
degree(ppi_g, v = "TRAF6")
degree(ppi_g, v = "IKBKG")
...
temp_inter <- immune_data %>%
  filter(Symbol %in% all_inter_genes)
...
SAB <- NetSci::separation_Significance(ppi_g,
                                    ST = Data_db,
                                    Threads = 5,
                                    N = 1000,
                                    correct_by_target = F)
...
CairoPDF("/Users/ursulawidocki/Desktop/BarabasiLab/Auto_Innate_GDA/Figures/Database_Jacc_Sep.pdf", width = 10, height = 8.5)
