...
```{r}
write.table(data, "/Users/ursulawidocki/Desktop/BarabasiLab/Data/Disease_Tissue_LCCs_GTEx_log_DEgenes2.tsv", row.names = F, col.names = T, sep = "\t")
```

```{r}
data <- fread("/Users/ursulawidocki/Desktop/BarabasiLab/Data/Disease_Tissue_LCCs_GTEx_log_DEgenes2.tsv")
```
...
p1 <- data %>%
  ...
  aes(x = Disease_Name, 
      ...
      shape = Significance) +
  geom_point() +
  scale_color_manual(values = c("padj < 0.05" = "#007CBE", "padj > 0.05" = "grey80")) +
...
CairoPDF("~/Desktop/BarabasiLab/Auto_Innate_GDA/Figures/Disease-Tissue_LCC_logDE2.pdf", width = 25, height = 20)
