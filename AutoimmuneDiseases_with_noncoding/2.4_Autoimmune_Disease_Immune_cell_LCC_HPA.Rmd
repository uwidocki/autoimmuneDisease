...
# gene categories
gene_categories <- fread("/Users/ursulawidocki/Desktop/BarabasiLab/Data/hgnc_category_set_2022-04-04.txt") %>% rename(`Gene name` = HGNC_Symbol)
...
immune_cell_df %<>% dplyr::select(-Gene) %>% dplyr::select(`Gene name`, `Blood cell`, nTPM)
immune_cell_df <- left_join(immune_cell_df, gene_categories)
